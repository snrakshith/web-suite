...
- Currying is a process in functional programming in which we transform a fucntion with multiple arguments into a sequence of nesting functions that take 1 argument at a time
