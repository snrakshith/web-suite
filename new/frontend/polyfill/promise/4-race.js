...
/**
 * Any promise which executed 1st, irrespective weather it gets resolved or rejected.
 * that result is returned first
 * Ex: Promise.any([t1(), t2(), t3()]) // op: "t3 success" as it gets 1st executed
 * as t3 is executed in 300ms
 */
