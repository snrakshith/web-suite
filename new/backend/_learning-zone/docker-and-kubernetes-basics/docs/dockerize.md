## We will dockerize the MERN app
...
- For optimizing the image size
  ...
  - We will setup a multistage docker build pipeline
  - we will use the official alpine Node.js image as the base image
  - store unwanted stuff in .dockerignore file

### Simple setup React & Node
...
### Complex setup for React & Node, if the app is written in Typescript
