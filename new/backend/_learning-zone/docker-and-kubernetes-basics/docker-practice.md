...
3. [Create and Start Containers](#3-create-and-start-containers)
4. [Logs, Stop and Kill Containers](#4-logs-stop-and-kill-containers)
5. [Inspect and Remove Containers](#5-inspect-and-remove-containers)
6. [Run a Command in a Running Container with exec](#6-run-a-command-in-a-running-container-with-exec)
7. [Creating Custom Image](#7-creating-custom-image)
8. [Creating an Image from a Dockerfile](#8-creating-an-image-from-a-dockerfile)
9. [COPY and ADD commands](#9-copy-and-add-commands)
10. [Dockerizing a Nodejs project and deploy in Docker-Hub](#10-dockerizing-a-nodejs-project-and-deploy-in-docker-hub)
11. [React and SQL-Server connectivity](#11-react-and-sql-server-connectivity)
...
- _[https://docs.microsoft.com/en-us/sql/linux/quickstart-install-connect-docker?view=sql-server-ver15&pivots=cs1-powershell](https://docs.microsoft.com/en-us/sql/linux/quickstart-install-connect-docker?view=sql-server-ver15&pivots=cs1-powershell)_
...
- _[https://github.com/bradtraversy/docker-node-mongo](https://github.com/bradtraversy/docker-node-mongo)_
